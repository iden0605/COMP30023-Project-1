...
/* Handle the previous tick's running process, applies demotion as needed. */
void handle_prev_running(SchedState *s);

/* Move processes whose I/O burst just completed from BLOCKED to READY */
...
/* Update the simulation by one tick, decrements the running process's
